...
function AdminFacilityBooking() {
  ...
  const fetchResources = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/all-resources`, {
        headers: {
  ...
  const handleAddResource = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token"); // Assuming the token is stored after login
      await axios.post(`${import.meta.env.VITE_API_URL}/add-resource`, newResource, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDelete = async (resourceId) => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/delete-resource/${resourceId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const confirmBooking = async (bookingId) => {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_API_URL}/confirm-booking/${bookingId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const cancelBooking = async (bookingId) => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/cancel-booking/${bookingId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
